#!/usr/bin/env python3
"""
Comprehensive Benchmark: BERT, RoBERTa, Linear Regression, and SVM

This script compares:
1. BERT (with SMOTE)
2. RoBERTa (with SMOTE) 
3. Linear Regression (with SMOTE)
4. SVM (with SMOTE)
5. Baseline models for comparison

Usage:
    python scripts/benchmark_classifiers.py --source reddit --mode train
"""
...
def apply_smote_sklearn(texts, labels, target_ratio=0.3):
    """Apply SMOTE for sklearn models"""
    print(f"\nApplying SMOTE for sklearn models...")
...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=3, help='Number of training epochs for transformers')
    ...
    if args.mode == 'train':
        ...
        sklearn_texts, sklearn_labels = apply_smote_sklearn(train_texts, train_labels)
        ...
        # Train sklearn models
        sklearn_models, sklearn_results = train_sklearn_models(X_train, sklearn_labels, X_val, val_labels, X_test, test_labels)
        ...
        bert_texts, bert_labels = apply_smote_sklearn(train_texts, train_labels)
