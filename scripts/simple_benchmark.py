#!/usr/bin/env python3
"""
Simple Benchmark: BERT, RoBERTa, Linear Regression, and SVM
...
Usage:
    python scripts/simple_benchmark.py --source reddit --mode train
"""
...
def main():
    parser = argparse.ArgumentParser(description='Simple Benchmark Classifiers')
